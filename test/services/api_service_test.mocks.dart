...
// in shorten_my_link/test/services/api_service_test.dart.
...
import 'package:shorten_my_link/repositories/storage_repository.dart' as _i11;
...
///
/// See the documentation for Mockito's code generation for more information.
class MockStorageRepository extends _i1.Mock implements _i11.StorageRepository {
  ...
  @override
  _i8.Box<String> get db =>
      (super.noSuchMethod(
            Invocation.getter(#db),
            returnValue: _FakeBox_6<String>(this, Invocation.getter(#db)),
          )
          as _i8.Box<String>);

  @override
  set db(_i8.Box<String>? _db) => super.noSuchMethod(
  ...
  List<String> values() =>
      (super.noSuchMethod(
            Invocation.method(#values, []),
            returnValue: <String>[],
          )
          as List<String>);

  @override
  _i9.Future<void> add(String? key, String? data) =>
      (super.noSuchMethod(
            Invocation.method(#add, [key, data]),
